...
metadata {
    ...
    definition (name: "Baz's Simulated Bella Status", namespace: "Using", author: "Baz2473") {
        capability "Switch"
    ...
    tiles(scale:2) {
        ...
        standardTile("off2", "device.switch", width: 5, height: 1,  decoration: "flat") {
            state "default", action: "off",backgroundColor: "#ffffff"
        }
        standardTile("off1", "device.switch", width: 1, height: 1,  decoration: "flat") {
            state "default", action: "on",backgroundColor: "#ffffff"
        }
        main "switch"
